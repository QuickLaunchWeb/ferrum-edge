...
- **38 built-in plugins**: Authentication, authorization, rate limiting, compression, transformation, serverless functions, AI/LLM-specific plugins, and observability
