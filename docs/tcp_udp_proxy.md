...
| `FERRUM_UDP_CONNECTED_SOCKETS_ENABLED` | `auto` | Reserved — connected UDP sockets were removed from the reply path (4-tuple demux steals incoming datagrams). Env var retained for future recv-path integration |
