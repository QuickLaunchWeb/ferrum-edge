...
| `FERRUM_MESH_PEER_AUTH_LIVE_RELOAD_ENABLED` | No | `false` | Opt in to live reload of PeerAuthentication-derived inbound mTLS mode and frontend client CA verifier on mesh slice apply. Frontend cert/key paths remain restart-required static inputs |
