...
| `FERRUM_METRICS_LOG_COUNTER_ENABLED` | No | `true` | Count Ferrum tracing events by level and bounded category for `/metrics/runtime`, independent of the output `FERRUM_LOG_LEVEL` / `RUST_LOG` filter |
