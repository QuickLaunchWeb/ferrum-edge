...
| `FERRUM_METRICS_LOG_COUNTER_ENABLED` | No | `true` | Count tracing events by level and bounded category for `/metrics/runtime`; counters mirror events allowed by `FERRUM_LOG_LEVEL` / `RUST_LOG` |
