...
pub mod v002_destination_rule_fields;
    ...
    fn all_migrations(&self) -> Vec<Box<dyn MigrationEntry>> {
        vec![
            ...
            Box::new(MigrationEntryV002(
                v002_destination_rule_fields::V002DestinationRuleFields,
            )),
        ]
    }
...
/// Wrapper for V002DestinationRuleFields.
struct MigrationEntryV002(v002_destination_rule_fields::V002DestinationRuleFields);
