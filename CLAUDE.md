...
├── plugins/                   # Plugin system (42 plugins, including 4 AI/LLM, 1 serverless, 1 compression, 1 SSE, 3 gRPC, 3 WS frame, and 1 UDP datagram plugin)
...
9. `log` — Stdout logging (9000), StatsD logging (9075), HTTP logging (9100), transaction debugger (9200, `tracing::debug` on `transaction_debug` target), Prometheus (9300), OTel tracing (25)
