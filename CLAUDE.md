...
- **Active request concurrency**: `FERRUM_DNS_MAX_ACTIVE_REQUESTS` (default 128, range 1-1024) limits in-flight queries per multiplexed upstream connection. Higher values improve throughput during bulk warmup.
