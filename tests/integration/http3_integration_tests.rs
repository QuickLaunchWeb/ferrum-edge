...
async fn test_http3_coalesce_defaults() {
    // Defaults should produce one coalesced 32 KiB frame for typical small-to-
    // medium payloads while keeping the time-based flush tight enough that
