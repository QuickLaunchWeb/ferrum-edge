...
start_gateway() {
    ...
    local env_cmd=(
        ...
        # HTTP/3 QUIC transport tuning (16 MiB stream, 128 MiB connection, 64 MiB send)
        FERRUM_HTTP3_MAX_STREAMS=1000
        FERRUM_HTTP3_STREAM_RECEIVE_WINDOW=16777216
        FERRUM_HTTP3_RECEIVE_WINDOW=134217728
        FERRUM_HTTP3_SEND_WINDOW=67108864
